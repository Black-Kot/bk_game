...
function bk_game.register_tree(name, TreeDef)
	...
	--
	minetest.register_craft({
		output = "blocks:"..tree.name:remove_modname_prefix().."_planks_slab",
		recipe = {
			{tree.name.."_plank",tree.name.."_plank"},
		},
	})
	minetest.register_craft({
		output = "blocks:"..tree.name:remove_modname_prefix().."_planks_stair",
		recipe = {
			{tree.name.."_plank",""},
			{tree.name.."_plank",tree.name.."_plank"},
		},
	...
	minetest.register_craft({
		...
		recipe = {{"blocks:"..tree.name:remove_modname_prefix().."_planks_stair"}}
	})
	minetest.register_craft({
